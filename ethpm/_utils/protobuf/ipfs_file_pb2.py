...
_PBLINK = DESCRIPTOR.message_types_by_name['PBLink']
_PBNODE = DESCRIPTOR.message_types_by_name['PBNode']
_DATA_DATATYPE = _DATA.enum_types_by_name['DataType']
Data = _reflection.GeneratedProtocolMessageType('Data', (_message.Message,), {
  'DESCRIPTOR' : _DATA,
  '__module__' : 'ipfs_file_pb2'
  # @@protoc_insertion_point(class_scope:Data)
  })
_sym_db.RegisterMessage(Data)

PBLink = _reflection.GeneratedProtocolMessageType('PBLink', (_message.Message,), {
  'DESCRIPTOR' : _PBLINK,
  '__module__' : 'ipfs_file_pb2'
...
PBNode = _reflection.GeneratedProtocolMessageType('PBNode', (_message.Message,), {
  'DESCRIPTOR' : _PBNODE,
  '__module__' : 'ipfs_file_pb2'
